...
namespace CouchRS.Test
{
    ...
    public class when_visiting_a_query_with_a_string_literal
    {
        ...
        It should_have_a_string_valued_key = () =>
                                             uri.ToString().ShouldEqual(@"http://localhost:5984/test/_design/projects/_view/view_all?key=""bar""");

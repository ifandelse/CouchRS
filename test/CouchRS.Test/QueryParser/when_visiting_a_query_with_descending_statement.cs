...
namespace CouchRS.Test
{
    ...
    public class when_visiting_a_query_with_descending_statement
    {
        ...
        Establish context = () =>
                        ...
                        USING QUERYOPTIONS(GROUP=true, GROUP_LEVEL=3, DESCENDING=true)
        ...
        It should_have_a_correct_uri = () =>
                                       uri.ToString().ShouldEqual(@"http://localhost:5984/test/_design/projects/_view/view_all?group=true&group_level=3&descending=true&key=[true,true,""scrambled""]");

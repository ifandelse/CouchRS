...
namespace CouchRS.Test.QueryParser
{
    ...
    public class when_visiting_a_query_with_null_operand
    {
        ...
        It should_have_a_correct_uri = () =>
                                       uri.ToString().ShouldEqual(@"http://localhost:5984/test/_design/projects/_view/view_all?group=true&group_level=3&descending=true&skip=10&key=null");

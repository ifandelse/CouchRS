...
namespace CouchRS.Test
{
    ...
    public class when_visiting_a_query_with_object_key
    {
        ...
        It should_have_the_correct_key_format = () =>
                                                uri.ToString().ShouldEqual(@"http://localhost:5984/test/_design/projects/_view/view_all?key={""foo"":""bacon"",""bar"":""sizzle""}");
